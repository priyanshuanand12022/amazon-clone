    ...
    <nav className="navbar">
      <div className="navbar-main">
        <Link to="/" className="navbar-logo">
          ...
          <svg
            className="navbar-logo-smile"
            viewBox="0 0 84 24"
            aria-hidden="true"
          >
            <path
              d="M6 8.5C18 18.5 50 20 68.5 10"
              fill="none"
              stroke="#ff9900"
              strokeWidth="4.1"
              strokeLinecap="round"
        ...
        <div className="navbar-location">
          ...
          <div>
            ...
            <strong>New Delhi 110010</strong>
          </div>
        </div>
      ...
      <div className="navbar-sub-bg">
        <div className="navbar-sub">
          ...
          {navCategories.map((category) => (
            <div key={category.id} className="navbar-sub-item-group">
              <Link
              ...
              {category.slug === 'appliances' && (
                <Link to="/sell" className="navbar-sub-link">Sell</Link>
              )}
            </div>
          ))}
          {categories
